...
const ReceptionistDashboard = ({ stats, recentActivities }: any) => (
  <div className="p-6 space-y-6">
    <div>
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Welcome, Receptionist!</h1>
      <p className="text-gray-500 dark:text-slate-300">Manage check-ins, bookings, and guest services</p>
    </div>
    ...
    <Card>
      ...
      <div className="space-y-3">
        {recentActivities?.slice(0, 5).map((activity: any) => (
          <div
            key={activity.id}
            className="flex items-center justify-between p-3 bg-mint-50 dark:bg-slate-700 rounded-lg"
          >
            <div>
              <p className="font-medium text-gray-800 dark:text-white">{activity.guest_name}</p>
              <p className="text-sm text-gray-500 dark:text-slate-300">Room {activity.room_number}</p>
            </div>
...
const HousekeepingDashboard = () => (
  <div className="p-6 space-y-6">
    <div>
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Housekeeping Dashboard</h1>
    ...
    <Card>
      <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Today's Tasks</h3>
      <div className="space-y-3">
        {[
          ...
          <div key={i} className="flex items-center justify-between p-4 bg-mint-50 dark:bg-slate-700 rounded-lg">
            <div className="flex items-center gap-3">
              <Bed className="w-5 h-5 text-gray-500" />
              <div>
                <p className="font-semibold text-gray-800 dark:text-white">Room {task.room}</p>
                <p className="text-sm text-gray-500 dark:text-slate-300">{task.task}</p>
              </div>
            </div>
...
const MaintenanceDashboard = () => (
  <div className="p-6 space-y-6">
    <div>
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Maintenance Dashboard</h1>
      <p className="text-gray-500 dark:text-slate-300">Track and resolve maintenance issues</p>
    </div>
    ...
    <Card>
      <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Active Maintenance Requests</h3>
      <div className="space-y-3">
        {[
          ...
          <div key={i} className="flex items-center justify-between p-4 bg-mint-50 dark:bg-slate-700 rounded-lg">
            <div>
              <p className="font-semibold text-gray-800 dark:text-white">Room {request.room}</p>
              <p className="text-sm text-gray-500 dark:text-slate-300">{request.issue}</p>
            </div>
            <span className={`text-xs px-3 py-1 rounded-full ${
...
const AccountantDashboard = ({ stats, revenueData }: any) => (
  <div className="p-6 space-y-6">
    <div>
      ...
      <p className="text-gray-500 dark:text-slate-300">Monitor revenue and financial metrics</p>
    </div>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <ComposedChart data={revenueData}>
              ...
              <Line
                ...
                activeDot={{ r: 7, fill: '#2563EB', strokeWidth: 3, stroke: '#fff' }}
            ...
            {recentActivities?.map((activity: any) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-seafoam-600 dark:text-gold-400">
