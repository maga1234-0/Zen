-- ============================================
-- CRÉER LES TABLES DU MODULE RESTAURANT
...
INSERT INTO menu_categories (name, name_fr, type, display_order) VALUES
('Entrées', 'Entrées', 'food', 1),
('Plats Principaux', 'Plats Principaux', 'food', 2),
('Desserts', 'Desserts', 'food', 3),
('Boissons', 'Boissons', 'beverage', 4)
ON CONFLICT DO NOTHING;

INSERT INTO menu_items (category_id, name, name_fr, description, price, is_available) 
SELECT 
    c.id,
    'Salade César',
    'Salade César',
    'Salade fraîche avec poulet grillé, parmesan et croûtons',
    12.50,
    true
...
('T4', 2, 'terrace', 'available'),
('T5', 4, 'terrace', 'available'),
('BAR1', 8, 'bar', 'available')
ON CONFLICT DO NOTHING;

-- Message de confirmation
SELECT 'Tables du module Restaurant créées avec succès!' as message;
